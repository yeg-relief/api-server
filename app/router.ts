...
export class MyRouter {
    ...
    private notification: Handlers.Notification;
    ...
    constructor(
        ...
        this.notification = new Handlers.Notification(this.notifications);
    ...
    private parseRouteDeclarations(): RouteDeclaration[] {
        return [
            ...
            // screener => this is for accessing the notification engine and returning programs
            ...
            { Prefix: API, Path: '/program/:guid', Verb: GET, Handler: this.userProgramHandler.getProgram() },

            // notifications => submit data and receive program notifications (UserProgram)
            { Prefix: API, Path: '/notification/', Verb: POST, Handler: this.notification.notify()}
        ]
    }
